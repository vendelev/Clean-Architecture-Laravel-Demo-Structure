...
В одном из проектов, где я принимал участие, ТехЛид сделал [экспорт настроек](https://www.jetbrains.com/help/phpstorm/editorconfig.html) из PHPStorm (там очень много всего) и запушил файл в Git. 
...
Знаю, что есть разработчики предпочитающие использовать VSCode, приглашаю их поделиться в комментах своими подборками плагинов для PHP.
