...
- **DTO** - упрощенно, это "типизированный ассоциативный массив".
  **_Формальное правило когда применять_**: _private_ и _protected_ методы могу принимать и возвращать ассоциативный массив, но _public_ метод должен принимать и возвращать DTO или список DTO
